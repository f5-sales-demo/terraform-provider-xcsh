---
page_title: "xcsh_allowed_domain Resource - xcsh"
subcategory: "Organization"
description: |-
  Manages allowed domain. in F5 Distributed Cloud.
---

# xcsh_allowed_domain (Resource)
...
<a id="name"></a>&#x2022; [`name`](#name) - Required String<br>Name of the Allowed Domain. Must be unique within the namespace

<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the Allowed Domain will be created
