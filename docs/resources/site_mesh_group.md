...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the Site Mesh Group is created
...
A [`bfd_enabled`](#bfd-enabled) block supports the following:

<a id="bfd-enabled-multiplier"></a>&#x2022; [`multiplier`](#bfd-enabled-multiplier) - Optional Number<br>Specify Number of missed packets to bring session down'

<a id="milliseconds-535f66"></a>&#x2022; [`receive_interval_milliseconds`](#milliseconds-535f66) - Optional Number<br>BFD receive interval timer, in milliseconds
