---
page_title: "xcsh_sensitive_data_policy Resource - xcsh"
...
# xcsh_sensitive_data_policy (Resource)
...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the Sensitive Data Policy is created
...
<a id="custom-data-types"></a>&#x2022; [`custom_data_types`](#custom-data-types) - Optional Block  Defaults to `[]`<br>Select your custom data types to be monitored in the API discovery.  Server applies default when omitted<br>See [Custom Data Types](#custom-data-types) below for details.
