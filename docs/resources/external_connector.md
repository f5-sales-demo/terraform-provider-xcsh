...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the External Connector is created
...
<a id="gre-gre-parameters-peer-ip-address"></a>&#x2022; [`peer_ip_address`](#gre-gre-parameters-peer-ip-address) - Optional Block<br>IPv4 Address. IPv4 Address in dot-decimal notation<br>See [Peer IP Address](#gre-gre-parameters-peer-ip-address) below.
...
<a id="gre-gre-parameters-peer-ip-address-addr"></a>&#x2022; [`addr`](#gre-gre-parameters-peer-ip-address-addr) - Optional String<br>IPv4 Address in string form with dot-decimal notation
...
<a id="gre-gre-parameters-tunnel-eps-interface"></a>&#x2022; [`interface`](#gre-gre-parameters-tunnel-eps-interface) - Optional String<br>For the chosen node, specify the interface that will be the tunnel source

<a id="tunnel-ip-1410aa"></a>&#x2022; [`local_tunnel_ip`](#tunnel-ip-1410aa) - Optional String<br>For a particular tunnel on a node, specify the local tunnel IP Address i.e. The IP address of the tunnel on the CE node itself and a subnet prefix length

<a id="gre-gre-parameters-tunnel-eps-node"></a>&#x2022; [`node`](#gre-gre-parameters-tunnel-eps-node) - Optional String<br>CE site is composed of multiple nodes. Choose a node that will be part of this external connection

<a id="tunnel-ip-b7057b"></a>&#x2022; [`remote_tunnel_ip`](#tunnel-ip-b7057b) - Optional String<br>For a particular tunnel on a node, specify the remote tunnel IP Address i.e. The IP address of the tunnel on the remote gateway and a subnet prefix length
