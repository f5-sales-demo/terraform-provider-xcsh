---
page_title: "xcsh_alert_gen_policy Resource - xcsh"
subcategory: "Security"
description: |-
  Manages Alert Generation Policy. in F5 Distributed Cloud.
---

# xcsh_alert_gen_policy (Resource)
...
<a id="name"></a>&#x2022; [`name`](#name) - Required String<br>Name of the Alert Gen Policy. Must be unique within the namespace

<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the Alert Gen Policy will be created
...
<a id="details-severity"></a>&#x2022; [`severity`](#details-severity) - Optional String  Defaults to `MINOR`<br>Possible values are `MINOR`, `MAJOR`, `CRITICAL`<br>[Enum: MINOR|MAJOR|CRITICAL] List of alert severities Minor Major Critical
