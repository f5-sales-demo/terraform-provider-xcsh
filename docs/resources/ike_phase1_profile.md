...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the IKE Phase1 Profile is created
...
<a id="authentication-algos"></a>&#x2022; [`authentication_algos`](#authentication-algos) - Required List  Defaults to `AUTH_ALG_DEFAULT`<br>Possible values are `AUTH_ALG_DEFAULT`, `SHA256_HMAC`, `SHA384_HMAC`, `SHA512_HMAC`, `AUTH_ALG_NONE`<br>[Enum: AUTH_ALG_DEFAULT|SHA256_HMAC|SHA384_HMAC|SHA512_HMAC|AUTH_ALG_NONE] Choose one or more Authentication Algorithm. Use None option when using the
AES-gcm or AES-ccm encryption algorithms

<a id="dh-group"></a>&#x2022; [`dh_group`](#dh-group) - Required List  Defaults to `DH_GROUP_DEFAULT`<br>Possible values are `DH_GROUP_DEFAULT`, `DH_GROUP_14`, `DH_GROUP_15`, `DH_GROUP_16`, `DH_GROUP_17`, `DH_GROUP_18`, `DH_GROUP_19`, `DH_GROUP_20`, `DH_GROUP_21`, `DH_GROUP_26`<br>[Enum:
...
<a id="ike-keylifetime-hours-duration"></a>&#x2022; [`duration`](#ike-keylifetime-hours-duration) - Optional Number<br>Duration. Configuration parameter for duration
...
<a id="reauth-timeout-days-duration"></a>&#x2022; [`duration`](#reauth-timeout-days-duration) - Optional Number<br>Duration. Configuration parameter for duration

#### Reauth Timeout Hours

A [`reauth_timeout_hours`](#reauth-timeout-hours) block supports the following:

<a id="reauth-timeout-hours-duration"></a>&#x2022; [`duration`](#reauth-timeout-hours-duration) - Optional Number<br>Duration. Configuration parameter for duration
