...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the Certificate is created
...
<a id="certificate-url"></a>&#x2022; [`certificate_url`](#certificate-url) - Required String<br>Certificate. Certificate or certificate chain in PEM format including the PEM headers
