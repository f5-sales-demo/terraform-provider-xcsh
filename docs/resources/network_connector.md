---
page_title: "xcsh_network_connector Resource - xcsh"
...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Optional String<br>Namespace for the Network Connector. The F5 XC API restricts this resource to the system namespace; it defaults to that value and may be omitted
...
<br><br>&#x2022; <a id="sli-to-slo-snat"></a>[`sli_to_slo_snat`](#sli-to-slo-snat) - Optional Block<br>Configuration parameter for SLI to slo snat<br>See [SLI To Slo Snat](#sli-to-slo-snat) below for details.
...
<a id="sli-to-slo-snat-default-gw-snat"></a>&#x2022; [`default_gw_snat`](#sli-to-slo-snat-default-gw-snat) - Optional Block<br>Configuration parameter for default gw snat
