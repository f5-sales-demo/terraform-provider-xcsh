...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the Policy Based Routing is created
...
Selector](#selector-c5a5b4) below.
...
[Metadata](#metadata-4bce2b) below.
...
specified by user during create<br>See [Metadata](#network-pbr-network-pbr-rules-metadata) below.
