---
page_title: "xcsh_geo_location_set Resource - xcsh"
subcategory: "Cloud Resources"
description: |-
  Manages Geolocation Set. in F5 Distributed Cloud.
---

# xcsh_geo_location_set (Resource)
...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Optional String<br>Namespace for the Geo Location Set. The F5 XC API restricts this resource to the system namespace; it defaults to that value and may be omitted
...
<a id="expressions-1d52c2"></a>&#x2022; [`expressions`](#expressions-1d52c2) - Optional List<br>Expressions contains the Kubernetes style label expression for selections
