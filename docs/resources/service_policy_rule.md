---
page_title: "xcsh_service_policy_rule Resource - xcsh"
...
# xcsh_service_policy_rule (Resource)
...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the Service Policy Rule is created
...
Selector](#client-selector) below for details.
...
<br><br>&#x2022; <a id="tls-fingerprint-matcher"></a>[`tls_fingerprint_matcher`](#tls-fingerprint-matcher) - Optional Block<br>TLS fingerprint matcher specifies multiple criteria for matching a TLS fingerprint. The set of supported positive match criteria includes a list of known classes of TLS fingerprints and a list of exact values. The match is considered successful if either of these positive
...
<a id="port-matcher"></a>&#x2022; [`port_matcher`](#port-matcher) - Optional Block<br>Port matcher specifies a list of port ranges as match criteria. The match is considered successful if the input port falls within any of the port ranges. The result of the match is inverted if invert_matcher is true. Server applies default when omitted<br>See [Port Matcher](#port-matcher) below for details.
...
Params](#query-params) below for details.

<a id="request-constraints"></a>&#x2022; [`request_constraints`](#request-constraints) - Optional Block<br>Configuration parameter for request constraints<br>See [Request Constraints](#request-constraints) below for details.
...
<a id="arg-matchers-item-transformers"></a>&#x2022; [`transformers`](#arg-matchers-item-transformers) - Optional List<br>See [Transformers](#common-transformers)<br> Ordered list of transformers (starting from index 0) to be applied to the path before matching
...
<a id="body-matcher-transformers"></a>&#x2022; [`transformers`](#body-matcher-transformers) - Optional List<br>See [Transformers](#common-transformers)<br> Ordered list of transformers (starting from index 0) to be applied to the path before matching
...
<a id="cookie-matchers-item-transformers"></a>&#x2022; [`transformers`](#cookie-matchers-item-transformers) - Optional List<br>See [Transformers](#common-transformers)<br> Ordered list of transformers (starting from index 0) to be applied to the path before matching
...
<a id="headers-item-transformers"></a>&#x2022; [`transformers`](#headers-item-transformers) - Optional List<br>See [Transformers](#common-transformers)<br> Ordered list of transformers (starting from index 0) to be applied to the path before matching
...
<a id="categories-f2b328"></a>&#x2022; [`ip_threat_categories`](#categories-f2b328) - Optional List  Defaults to `SPAM_SOURCES`<br>See [IP Threat Categories](#common-ip-threat-categories)<br>[Enum: SPAM_SOURCES|WINDOWS_EXPLOITS|WEB_ATTACKS|BOTNETS|SCANNERS|REPUTATION|PHISHING|PROXY|MOBILE_THREATS|TOR_PROXY|DENIAL_OF_SERVICE|NETWORK] The IP threat categories is obtained from the list and is used to
...
<a id="jwt-claims-item-transformers"></a>&#x2022; [`transformers`](#jwt-claims-item-transformers) - Optional List<br>See [Transformers](#common-transformers)<br> Ordered list of transformers (starting from index 0) to be applied to the path before matching
...
<a id="path-transformers"></a>&#x2022; [`transformers`](#path-transformers) - Optional List<br>See [Transformers](#common-transformers)<br> Ordered list of transformers (starting from index 0) to be applied to the path before matching
...
<a id="query-params-item-transformers"></a>&#x2022; [`transformers`](#query-params-item-transformers) - Optional List<br>See [Transformers](#common-transformers)<br> Ordered list of transformers (starting from index 0) to be applied to the path before matching
