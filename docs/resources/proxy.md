...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the Proxy is created
...
<a id="http-proxy-enable-http"></a>&#x2022; [`enable_http`](#http-proxy-enable-http) - Optional Block<br>Configuration parameter for enable HTTP
...
Policy](#http-proxy-more-option-buffer-policy) below.
