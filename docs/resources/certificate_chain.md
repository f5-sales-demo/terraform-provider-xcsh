---
page_title: "xcsh_certificate_chain Resource - xcsh"
...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the Certificate Chain is created
...
<a id="certificate-url"></a>&#x2022; [`certificate_url`](#certificate-url) - Required String<br>Certificate chain is the list of intermediate certificates in PEM format including the PEM headers
