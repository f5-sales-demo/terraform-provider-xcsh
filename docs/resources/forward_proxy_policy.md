...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the Forward Proxy Policy is created
...
objects<br>See [Dst Label Selector](#rule-list-rules-dst-label-selector) below.
...
[Label Selector](#rule-list-rules-label-selector) below.
