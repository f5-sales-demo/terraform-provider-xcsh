...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the GCP VPC Site is created
...
<a id="instance-type"></a>&#x2022; [`instance_type`](#instance-type) - Required String<br>Select Instance size based on performance needed
...
<a id="enable-encryption-kms-key-resource-id"></a>&#x2022; [`kms_key_resource_id`](#enable-encryption-kms-key-resource-id) - Optional String<br>GCP KMS Key to be used to encrypt the disk attached to the VM

<a id="enable-encryption-kms-key-ring-id"></a>&#x2022; [`kms_key_ring_id`](#enable-encryption-kms-key-ring-id) - Optional String<br>Key ring in which the CMK to be used to encrypt is present
...
<a id="network-9ee4a6"></a>&#x2022; [`existing_network`](#network-9ee4a6) - Optional Block<br>Configuration parameter for existing network<br>See [Existing Network](#network-9ee4a6) below.
...
<a id="autogenerate-1169b7"></a>&#x2022; [`new_network_autogenerate`](#autogenerate-1169b7) - Optional Object<br>Create a new GCP VPC Network with autogenerated name
...
<a id="subnet-d874b8"></a>&#x2022; [`existing_subnet`](#subnet-d874b8) - Optional Block<br>Configuration parameter for existing subnet<br>See [Existing Subnet](#subnet-d874b8) below.
...
<a id="network-7bcebe"></a>&#x2022; [`existing_network`](#network-7bcebe) - Optional Block<br>Configuration parameter for existing network<br>See [Existing Network](#network-7bcebe) below.
...
<a id="autogenerate-74de44"></a>&#x2022; [`new_network_autogenerate`](#autogenerate-74de44) - Optional Object<br>Create a new GCP VPC Network with autogenerated name
...
<a id="subnet-34a158"></a>&#x2022; [`existing_subnet`](#subnet-34a158) - Optional Block<br>Configuration parameter for existing subnet<br>See [Existing Subnet](#subnet-34a158) below.
...
<a id="network-16c1d3"></a>&#x2022; [`existing_network`](#network-16c1d3) - Optional Block<br>Configuration parameter for existing network<br>See [Existing Network](#network-16c1d3) below.
...
<a id="autogenerate-3c23a7"></a>&#x2022; [`new_network_autogenerate`](#autogenerate-3c23a7) - Optional Object<br>Create a new GCP VPC Network with autogenerated name
...
A [`new_network_autogenerate`](#autogenerate-3c23a7) block (within [`ingress_gw.local_network`](#ingress-gw-local-network)) supports the following:

#### Ingress Gw Local Subnet

A [`local_subnet`](#ingress-gw-local-subnet) block (within [`ingress_gw`](#ingress-gw)) supports the following:

<a id="ingress-gw-local-subnet-existing-subnet"></a>&#x2022; [`existing_subnet`](#ingress-gw-local-subnet-existing-subnet) - Optional Block<br>Configuration parameter for existing subnet<br>See [Existing Subnet](#ingress-gw-local-subnet-existing-subnet) below.
...
<a id="network-231a12"></a>&#x2022; [`existing_network`](#network-231a12) - Optional Block<br>Configuration parameter for existing network<br>See [Existing Network](#network-231a12) below.
...
<a id="autogenerate-cd8fd8"></a>&#x2022; [`new_network_autogenerate`](#autogenerate-cd8fd8) - Optional Object<br>Create a new GCP VPC Network with autogenerated name
...
<a id="subnet-73ee4c"></a>&#x2022; [`existing_subnet`](#subnet-73ee4c) - Optional Block<br>Configuration parameter for existing subnet<br>See [Existing Subnet](#subnet-73ee4c) below.
