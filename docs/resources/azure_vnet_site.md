---
page_title: "xcsh_azure_vnet_site Resource - xcsh"
subcategory: "Sites"
description: |-
...
<br><br>&#x2022; <a id="ingress-gw-ar"></a>[`ingress_gw_ar`](#ingress-gw-ar) - Optional Block<br>Configuration parameter for ingress gw ar
...
<a id="set-id-86fb8c"></a>&#x2022; [`disk_encryption_set_id`](#set-id-86fb8c) - Optional String<br>Azure Disk Encryption Set to be used to encrypt the disk attached to the VM

<a id="enable-encryption-resource-group"></a>&#x2022; [`resource_group`](#enable-encryption-resource-group) - Optional String<br>The resource group in which the Disk Encryption Set is present
...
<a id="subnet-c9a09c"></a>&#x2022; [`subnet`](#subnet-c9a09c) - Optional Block<br>Subnet specification for network segmentation<br>See [Subnet](#subnet-c9a09c) below.
...
<a id="subnet-251935"></a>&#x2022; [`subnet`](#subnet-251935) - Optional Block<br>Subnet specification for network segmentation<br>See [Subnet](#subnet-251935) below.
...
<a id="labels-9c843f"></a>&#x2022; [`labels`](#labels-9c843f) - Optional Map<br>Add Labels for each of the VNets peered with transit VNET, these labels can be used in firewall policy These labels used must be from known key and label defined in shared namespace
...
<a id="labels-06e528"></a>&#x2022; [`labels`](#labels-06e528) - Optional Map<br>Add Labels for each of the VNets peered with transit VNET, these labels can be used in firewall policy These labels used must be from known key and label defined in shared namespace
...
<a id="ingress-egress-gw-ar-node-inside-subnet"></a>&#x2022; [`inside_subnet`](#ingress-egress-gw-ar-node-inside-subnet) - Optional Block<br>Configuration parameter for inside subnet<br>See [Inside Subnet](#ingress-egress-gw-ar-node-inside-subnet) below.
...
<a id="subnet-a70a4a"></a>&#x2022; [`outside_subnet`](#subnet-a70a4a) - Optional Block<br>Configuration parameter for outside subnet<br>See [Outside Subnet](#subnet-a70a4a) below.
...
<a id="subnet-fde5af"></a>&#x2022; [`subnet`](#subnet-fde5af) - Optional Block<br>Subnet specification for network segmentation<br>See [Subnet](#subnet-fde5af) below.
...
<a id="subnet-8747e2"></a>&#x2022; [`subnet`](#subnet-8747e2) - Optional Block<br>Subnet specification for network segmentation<br>See [Subnet](#subnet-8747e2) below.
...
<a id="ingress-gw-az-nodes-local-subnet-subnet"></a>&#x2022; [`subnet`](#ingress-gw-az-nodes-local-subnet-subnet) - Optional Block<br>Subnet specification for network segmentation<br>See [Subnet](#ingress-gw-az-nodes-local-subnet-subnet) below.
...
<a id="ingress-gw-ar-node-local-subnet"></a>&#x2022; [`local_subnet`](#ingress-gw-ar-node-local-subnet) - Optional Block<br>Configuration parameter for local subnet<br>See [Local Subnet](#ingress-gw-ar-node-local-subnet) below.
...
<a id="ingress-gw-ar-node-local-subnet-subnet"></a>&#x2022; [`subnet`](#ingress-gw-ar-node-local-subnet-subnet) - Optional Block<br>Subnet specification for network segmentation<br>See [Subnet](#ingress-gw-ar-node-local-subnet-subnet) below.
...
<a id="subnet-4f7eec"></a>&#x2022; [`subnet`](#subnet-4f7eec) - Optional Block<br>Subnet specification for network segmentation<br>See [Subnet](#subnet-4f7eec) below.
...
<a id="voltstack-cluster-ar-node-local-subnet"></a>&#x2022; [`local_subnet`](#voltstack-cluster-ar-node-local-subnet) - Optional Block<br>Configuration parameter for local subnet<br>See [Local Subnet](#voltstack-cluster-ar-node-local-subnet) below.
...
<a id="subnet-cc9194"></a>&#x2022; [`subnet`](#subnet-cc9194) - Optional Block<br>Subnet specification for network segmentation<br>See [Subnet](#subnet-cc9194) below.
