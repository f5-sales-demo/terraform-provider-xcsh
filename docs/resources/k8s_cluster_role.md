...
&#x2022; <a id="k8s-cluster-role-selector"></a>[`k8s_cluster_role_selector`](#k8s-cluster-role-selector) - Optional Block<br>Type can be used to establish a 'selector reference' from one object(called selector) to a set of other objects(called selectees) based on the value of expressions. A label selector is a label query over a set of resources. An empty label selector matches all objects<br>See
[K8S Cluster Role Selector](#k8s-cluster-role-selector) below for details.
...
<br><br>&#x2022; <a id="yaml"></a>[`yaml`](#yaml) - Optional String<br>K8S YAML for ClusterRole
...
<a id="k8s-cluster-role-selector-expressions"></a>&#x2022; [`expressions`](#k8s-cluster-role-selector-expressions) - Optional List<br>Expressions contains the Kubernetes style label expression for selections
...
<a id="list-d430d1"></a>&#x2022; [`non_resource_url_list`](#list-d430d1) - Optional Block<br>Permissions for URL(s) that do not represent K8S resource<br>See [Non Resource URL List](#list-d430d1) below.

<a id="list-0add02"></a>&#x2022; [`resource_list`](#list-0add02) - Optional Block<br>List of resources in terms of API groups/resource types/resource instances and verbs allowed<br>See [Resource List](#list-0add02) below.
...
<a id="groups-8a629b"></a>&#x2022; [`api_groups`](#groups-8a629b) - Optional List<br>Allowed list of API group that contains resources, all resources of a given API group

<a id="instances-311644"></a>&#x2022; [`resource_instances`](#instances-311644) - Optional List<br>Allowed list of resource instances within the resource types

<a id="types-062a5a"></a>&#x2022; [`resource_types`](#types-062a5a) - Optional List<br>Allowed list of resource types within the API groups

<a id="verbs-d805f1"></a>&#x2022; [`verbs`](#verbs-d805f1) - Optional List<br>Allowed list of verbs(operations) on resources. Use \* for all operations
