---
page_title: "xcsh_protocol_inspection Resource - xcsh"
...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Optional String<br>Namespace for the Protocol Inspection. The F5 XC API restricts this resource to the system namespace; it defaults to that value and may be omitted
...
<a id="enable-disable-signatures"></a>&#x2022; [`enable_disable_signatures`](#enable-disable-signatures) - Optional Block<br>Configuration parameter for enable disable signatures<br>See [Enable Disable Signatures](#enable-disable-signatures) below for details.
