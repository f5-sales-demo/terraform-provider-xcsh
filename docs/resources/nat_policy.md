...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the NAT Policy is created
...
<a id="rules-cloud-connect"></a>&#x2022; [`cloud_connect`](#rules-cloud-connect) - Optional Block<br>Configuration parameter for cloud connect<br>See [Cloud Connect](#rules-cloud-connect) below.
...
<a id="rules-node-interface-list"></a>&#x2022; [`list`](#rules-node-interface-list) - Optional Block<br>On a multinode site, this list holds the nodes and corresponding networking_interface<br>See [List](#rules-node-interface-list) below.
...
<a id="rules-node-interface-list-interface-uid"></a>&#x2022; [`uid`](#rules-node-interface-list-interface-uid) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then uid will hold the referred object's(e.g. Route's) uid
