...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Optional String<br>Namespace for the Fast ACL. The F5 XC API restricts this resource to the system namespace; it defaults to that value and may be omitted
...
during create<br>See [Metadata](#re-acl-fast-acl-rules-metadata) below.
...
user during create<br>See [Metadata](#site-acl-fast-acl-rules-metadata) below.
