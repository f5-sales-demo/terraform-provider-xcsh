...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the Secret Management Access is created
...
<a id="provider-name"></a>&#x2022; [`provider_name`](#provider-name) - Required String<br>Name given to this secret management backend. site.provider needs to be unique, and will be referenced for using this object
