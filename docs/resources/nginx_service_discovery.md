---
page_title: "xcsh_nginx_service_discovery Resource - xcsh"
...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Optional String<br>Namespace for the Nginx Service Discovery. The F5 XC API restricts this resource to the system namespace; it defaults to that value and may be omitted

### Spec Argument Reference

<a id="discovery-target"></a>&#x2022; [`discovery_target`](#discovery-target) - Optional Block<br>Configuration parameter for discovery target<br>See [Discovery Target](#discovery-target) below for details.

<a id="server-block-filters"></a>&#x2022; [`server_block_filters`](#server-block-filters) - Optional Block<br>Filters discovered server blocks based on server name, domain and ports. Atleast, one field should be populated for each filter. X-textBlockContent: If no filters are specified, all server blocks will be discovered by default<br>See [Server Block Filters](#server-block-filters) below for
details.
...
<a id="discovery-target-config-sync-group"></a>&#x2022; [`config_sync_group`](#discovery-target-config-sync-group) - Optional Block<br>Configuration parameter for config sync group<br>See [Config Sync Group](#discovery-target-config-sync-group) below.
