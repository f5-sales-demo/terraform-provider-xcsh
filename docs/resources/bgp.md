...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the BGP is created
...
<a id="bgp-parameters"></a>&#x2022; [`bgp_parameters`](#bgp-parameters) - Optional Block<br>Configuration parameter for BGP parameters<br>See [BGP Parameters](#bgp-parameters) below for details.
