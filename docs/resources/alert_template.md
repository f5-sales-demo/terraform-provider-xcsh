---
page_title: "xcsh_alert_template Resource - xcsh"
subcategory: "Monitoring"
description: |-
  Manages Domain to protect. in F5 Distributed Cloud.
---

# xcsh_alert_template (Resource)
...
<a id="name"></a>&#x2022; [`name`](#name) - Required String<br>Name of the Alert Template. Must be unique within the namespace

<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the Alert Template will be created
