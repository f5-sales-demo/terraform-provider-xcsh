---
page_title: "xcsh_crl Resource - xcsh"
...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the CRL is created
...
<a id="http-access"></a>&#x2022; [`http_access`](#http-access) - Optional Block<br>Configuration parameter for HTTP access<br>See [HTTP Access](#http-access) below for details.
...
<a id="timeout"></a>&#x2022; [`timeout`](#timeout) - Required Number<br>CRL download timeout. CRL download wait time, in seconds
