...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the Nfv Service is created
...
<a id="https-management"></a>&#x2022; [`https_management`](#https-management) - Optional Block<br>Configuration parameter for HTTPS management<br>See [HTTPS Management](#https-management) below for details.
...
<a id="f5-big-ip-aws-service-nodes-mgmt-subnet"></a>&#x2022; [`mgmt_subnet`](#f5-big-ip-aws-service-nodes-mgmt-subnet) - Optional Block<br>Configuration parameter for mgmt subnet<br>See [Mgmt Subnet](#f5-big-ip-aws-service-nodes-mgmt-subnet) below.
...
<a id="https-management-advertise-on-slo-sli"></a>&#x2022; [`advertise_on_slo_sli`](#https-management-advertise-on-slo-sli) - Optional Block<br>Configuration parameter for advertise on slo SLI<br>See [Advertise On Slo SLI](#https-management-advertise-on-slo-sli) below.
...
`PALO_ALTO_FW_AWS_INSTANCE_TYPE_C4_LARGE`, `PALO_ALTO_FW_AWS_INSTANCE_TYPE_C4_XLARGE`, `PALO_ALTO_FW_AWS_INSTANCE_TYPE_C4_2XLARGE`, `PALO_ALTO_FW_AWS_INSTANCE_TYPE_C4_4XLARGE`, `PALO_ALTO_FW_AWS_INSTANCE_TYPE_C4_8XLARGE`, `PALO_ALTO_FW_AWS_INSTANCE_TYPE_C5_LARGE`, `PALO_ALTO_FW_AWS_INSTANCE_TYPE_C5_XLARGE`, `PALO_ALTO_FW_AWS_INSTANCE_TYPE_C5_2XLARGE`, `PALO_ALTO_FW_AWS_INSTANCE_TYPE_C5_4XLARGE`,
`PALO_ALTO_FW_AWS_INSTANCE_TYPE_C5_9XLARGE`, `PALO_ALTO_FW_AWS_INSTANCE_TYPE_C5_18XLARGE`, `PALO_ALTO_FW_AWS_INSTANCE_TYPE_C5N_LARGE`, `PALO_ALTO_FW_AWS_INSTANCE_TYPE_C5N_XLARGE`, `PALO_ALTO_FW_AWS_INSTANCE_TYPE_C5N_2XLARGE`, `PALO_ALTO_FW_AWS_INSTANCE_TYPE_C5N_4XLARGE`, `PALO_ALTO_FW_AWS_INSTANCE_TYPE_C5N_9XLARGE`, `PALO_ALTO_FW_AWS_INSTANCE_TYPE_C5N_18XLARGE`,
`PALO_ALTO_FW_AWS_INSTANCE_TYPE_R5_2XLARGE`<br>[Enum:
...
<a id="palo-alto-fw-service-service-nodes"></a>&#x2022; [`service_nodes`](#palo-alto-fw-service-service-nodes) - Optional Block<br>Configuration parameter for service nodes<br>See [Service Nodes](#palo-alto-fw-service-service-nodes) below.
...
<a id="subnet-0f55cf"></a>&#x2022; [`mgmt_subnet`](#subnet-0f55cf) - Optional Block<br>Configuration parameter for mgmt subnet<br>See [Mgmt Subnet](#subnet-0f55cf) below.
