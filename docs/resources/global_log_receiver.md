...
<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Optional String<br>Namespace for the Global Log Receiver. The F5 XC API restricts this resource to the system namespace; it defaults to that value and may be omitted
...
<br><br>&#x2022; <a id="new-relic-receiver"></a>[`new_relic_receiver`](#new-relic-receiver) - Optional Block<br>Configuration parameter for new relic receiver
<br><br>&#x2022; <a id="qradar-receiver"></a>[`qradar_receiver`](#qradar-receiver) - Optional Block<br>Configuration parameter for qradar receiver
...
<a id="aws-cloud-watch-receiver-compression"></a>&#x2022; [`compression`](#aws-cloud-watch-receiver-compression) - Optional Block<br>Configuration parameter for compression<br>See [Compression](#aws-cloud-watch-receiver-compression) below.
...
<a id="datadog-receiver-compression"></a>&#x2022; [`compression`](#datadog-receiver-compression) - Optional Block<br>Configuration parameter for compression<br>See [Compression](#datadog-receiver-compression) below.
...
<a id="gcp-bucket-receiver-compression"></a>&#x2022; [`compression`](#gcp-bucket-receiver-compression) - Optional Block<br>Configuration parameter for compression<br>See [Compression](#gcp-bucket-receiver-compression) below.
...
<a id="http-receiver-auth-basic-user-name"></a>&#x2022; [`user_name`](#http-receiver-auth-basic-user-name) - Optional String<br>username. HTTP Basic Auth username
...
<a id="kafka-receiver-compression"></a>&#x2022; [`compression`](#kafka-receiver-compression) - Optional Block<br>Configuration parameter for compression<br>See [Compression](#kafka-receiver-compression) below.
...
<a id="s3-receiver-compression"></a>&#x2022; [`compression`](#s3-receiver-compression) - Optional Block<br>Configuration parameter for compression<br>See [Compression](#s3-receiver-compression) below.
...
<a id="splunk-receiver-compression"></a>&#x2022; [`compression`](#splunk-receiver-compression) - Optional Block<br>Configuration parameter for compression<br>See [Compression](#splunk-receiver-compression) below.
