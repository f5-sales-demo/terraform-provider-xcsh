---
page_title: "xcsh_addon_service_activation_status Data Source - xcsh"
...
# xcsh_addon_service_activation_status (Data Source)

Checks the activation status of an F5 Distributed Cloud Addon Service. This is a read-only data source.
