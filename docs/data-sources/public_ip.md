---
page_title: "xcsh_public_ip Data Source - xcsh"
subcategory: "Uncategorized"
description: |-
  Retrieves information about an existing Public IP resource in F5 Distributed Cloud for get public_ip will get the object from the storage backend for namespace metadata.namespace. configuration. (read-only data source)
---

# xcsh_public_ip (Data Source)
...
<a id="name"></a>&#x2022; [`name`](#name) - Required String<br>Name of the PublicIP to look up

<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace of the PublicIP
...
<a id="virtual-sites"></a>&#x2022; [`virtual_sites`](#virtual-sites) - Optional String<br>Reference to virtual_site where this pubic IP will be available
