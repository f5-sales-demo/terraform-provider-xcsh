...
<a id="name"></a>&#x2022; [`name`](#name) - Required String<br>Name of the NginxInstance to look up

<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace of the NginxInstance
...
<a id="host-name"></a>&#x2022; [`host_name`](#host-name) - Optional String<br>Dataplane identifier name for instance in NGINX One

<a id="id"></a>&#x2022; [`id`](#id) - Optional String<br>Unique identifier

<a id="labels"></a>&#x2022; [`labels`](#labels) - Optional Map<br>Labels

<a id="object-id"></a>&#x2022; [`object_id`](#object-id) - Optional String<br>Identifier for individual instance in NGINX One
