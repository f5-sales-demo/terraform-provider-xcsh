---
page_title: "xcsh_crl Data Source - xcsh"
subcategory: "Uncategorized"
description: |-
  Retrieves information about an existing CRL resource in F5 Distributed Cloud for api to create crl object. configuration.
---

# xcsh_crl (Data Source)
...
<a id="http-access"></a>&#x2022; [`http_access`](#http-access) - Optional String<br>Configuration parameter for HTTP access
...
<a id="path"></a>&#x2022; [`path`](#path) - Optional String<br>CRL File path. CRL file location
