...
Manages Address Allocator will create an address allocator object in 'system' namespace of the user. in F5 Distributed Cloud. This is a read-only data source.
