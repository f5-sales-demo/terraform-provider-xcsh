...
<a id="name"></a>&#x2022; [`name`](#name) - Required String<br>Name of the NginxCsg to look up

<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace of the NginxCsg
...
<a id="csg-name"></a>&#x2022; [`csg_name`](#csg-name) - Optional String<br>CSGName. Name for CSG in NGINX One
...
<a id="object-id"></a>&#x2022; [`object_id`](#object-id) - Optional String<br>Identifier for config sync group in NGINX One
