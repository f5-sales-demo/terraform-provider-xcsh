...
var (
	_ datasource.DataSource              = &AllowedDomainDataSource{}
	_ datasource.DataSourceWithConfigure = &AllowedDomainDataSource{}
)

func NewAllowedDomainDataSource() datasource.DataSource {
	return &AllowedDomainDataSource{}
}

type AllowedDomainDataSource struct {
	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"name": schema.StringAttribute{
				MarkdownDescription: "Name of the AllowedDomain.",
				Required:            true,
			},
			"namespace": schema.StringAttribute{
				MarkdownDescription: "Namespace where the AllowedDomain exists.",
				Required:            true,
			},
			"description": schema.StringAttribute{
				MarkdownDescription: "Description of the AllowedDomain.",
				Computed:            true,
			},
...
func (d *AllowedDomainDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *AllowedDomainDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data AllowedDomainDataSourceModel
