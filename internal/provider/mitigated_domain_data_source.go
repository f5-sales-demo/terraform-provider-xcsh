...
var (
	_ datasource.DataSource              = &MitigatedDomainDataSource{}
	_ datasource.DataSourceWithConfigure = &MitigatedDomainDataSource{}
)

func NewMitigatedDomainDataSource() datasource.DataSource {
	return &MitigatedDomainDataSource{}
}

type MitigatedDomainDataSource struct {
...
func (d *MitigatedDomainDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"name": schema.StringAttribute{
				MarkdownDescription: "Name of the MitigatedDomain.",
				Required:            true,
			},
			"namespace": schema.StringAttribute{
				MarkdownDescription: "Namespace where the MitigatedDomain exists.",
				Required:            true,
			},
			"description": schema.StringAttribute{
				MarkdownDescription: "Description of the MitigatedDomain.",
				Computed:            true,
			},
...
func (d *MitigatedDomainDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *MitigatedDomainDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data MitigatedDomainDataSourceModel
