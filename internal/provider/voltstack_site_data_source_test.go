...
func TestAccVoltstackSiteDataSource_basic(t *testing.T) {
	...
	dataSourceName := "data.xcsh_voltstack_site.test"
...
data "xcsh_voltstack_site" "test" {
  depends_on = [xcsh_voltstack_site.test]
  name       = xcsh_voltstack_site.test.name
  namespace  = xcsh_voltstack_site.test.namespace
}
`, nsName, name))
}
