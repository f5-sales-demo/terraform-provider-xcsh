...
func (p *XCSHProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewProtectedApplicationResource,
		NewProtectedDomainResource,
...
func (p *XCSHProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewAuthorizationServerDataSource,
		NewAzureVNETSiteDataSource,
		NewBGPAsnSetDataSource,
		NewBGPDataSource,
		NewBGPRoutingPolicyDataSource,
		NewBigIPHTTPProxyDataSource,
		NewBigIPVirtualServerDataSource,
		NewBotAllowlistPolicyDataSource,
		NewBotDefenseAppInfrastructureDataSource,
		NewBotDetectionRuleDataSource,
		...
		NewCertifiedHardwareDataSource,
		...
		NewNetworkBotDefenseDataSource,
		NewNetworkCDNDataSource,
		NewNetworkConnectorDataSource,
		NewNetworkCustomerEdgeDefaultsDataSource,
		NewNetworkCustomerEdgeEgressDataSource,
		NewNetworkDataIntelligenceDataSource,
		NewNetworkDnslbHealthChecksDataSource,
		NewNetworkFirewallDataSource,
		NewNetworkGlobalControllerSSOEgressDataSource,
		NewNetworkGlobalLogReceiverDataSource,
		NewNetworkInterfaceDataSource,
		NewNetworkPolicyDataSource,
		NewNetworkPolicyRuleDataSource,
		NewNetworkPolicySetDataSource,
		NewNetworkPolicyViewDataSource,
		NewNetworkRegionalEdgesDataSource,
		NewNetworkSecondaryDNSZoneTransferDataSource,
		NewNfvServiceDataSource,
		NewNginxCsgDataSource,
		...
		NewSegmentConnectionDataSource,
		...
		NewSiteBGPStatusDataSource,
		NewSiteCloudInitDataSource,
		NewSiteDataSource,
