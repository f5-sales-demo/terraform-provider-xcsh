...
func TestAccAwsTgwSiteDataSource_basic(t *testing.T) {
	...
	dataSourceName := "data.xcsh_aws_tgw_site.test"
...
data "xcsh_aws_tgw_site" "test" {
  depends_on = [xcsh_aws_tgw_site.test]
  name       = xcsh_aws_tgw_site.test.name
  namespace  = xcsh_aws_tgw_site.test.namespace
}
`, nsName, name))
}
