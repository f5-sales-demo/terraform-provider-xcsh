...
var (
	_ datasource.DataSource              = &CloudRegionDataSource{}
	_ datasource.DataSourceWithConfigure = &CloudRegionDataSource{}
)
...
func (d *CloudRegionDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages a Cloud Region resource in F5 Distributed Cloud for cloud re specification. configuration. (read-only data source)",
		Attributes: map[string]schema.Attribute{
			...
			"name": schema.StringAttribute{
				MarkdownDescription: "Name of the CloudRegion to look up.",
				Required:            true,
			},
			"namespace": schema.StringAttribute{
				MarkdownDescription: "Namespace of the CloudRegion.",
				Required:            true,
			},
...
func (d *CloudRegionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	resource, err := d.client.GetCloudRegion(ctx, data.Namespace.ValueString(), data.Name.ValueString())
	if err != nil {
