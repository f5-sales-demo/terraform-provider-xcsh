...
func TestAccSecuremeshSiteDataSource_basic(t *testing.T) {
	...
	resourceName := "xcsh_securemesh_site.test"
	dataSourceName := "data.xcsh_securemesh_site.test"
...
data "xcsh_securemesh_site" "test" {
  depends_on = [xcsh_securemesh_site.test]
  name       = xcsh_securemesh_site.test.name
  namespace  = xcsh_securemesh_site.test.namespace
}
`, nsName, name))
}
