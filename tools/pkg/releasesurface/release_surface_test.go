...
func TestLoadSMSv2ReleaseSurfaceIsExact(t *testing.T) {
	...
	if got, want := surface.Resources, []string{"securemesh_site_v2", "token", "registration_approval", "external_connector", "bgp", "virtual_site", "origin_pool", "http_loadbalancer", "dns_zone"}; !reflect.DeepEqual(got, want) {
