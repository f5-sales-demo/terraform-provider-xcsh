...
func TestGenerateSMSv2ContractConstantsIsDeterministic(t *testing.T) {
	...
	contract := strings.Replace(syntheticSMSv2V5Contract,
		`"capabilities":{"aws_ce_create":"available","runtime_status":"available","tgw_connect":"available"},`,
		`"capabilities":{"aws_ce_create":"available","runtime_status":"available","tgw_connect":"available"},"telemetry_intake":{"schema_id":"f5xc-smsv2-aws-tgw-telemetry/v1","complete":true},`, 1)
	manifest := `{"contract_id":"f5xc-ce-automation/v2","contract_version":"5.0.0","release":{"tag":"v5.0.0","commit":"3a647f1bf0c2447a71750c69136fab96fb073902"}}`
	...
	for _, want := range []string{"f5xc-ce-automation/v2", "v5.0.0", "3a647f1bf0c2447a71750c69136fab96fb073902", "f5xc-smsv2-aws-tgw-telemetry/v1"} {
