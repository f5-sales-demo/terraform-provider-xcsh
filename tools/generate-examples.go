...
func addResourceSpecificConfig(sb *strings.Builder, resourceName string, schema *SchemaInfo) {
	...
	case "http_loadbalancer":
		...
		sb.WriteString("  default_sensitive_data_policy {}\n\n")
		...
		sb.WriteString("  disable_bot_defense {}\n\n")
	...
	case "service_policy":
		...
		sb.WriteString("        any_ip {}\n")
		sb.WriteString("        path {\n")
		sb.WriteString("          prefix_values = [\"/api/\"]\n")
		sb.WriteString("        }\n")
		sb.WriteString("      }\n")
		sb.WriteString("    }\n")
		sb.WriteString("  }\n\n")
		sb.WriteString("  // One of the arguments from this list \"any_server server_name server_name_matcher server_selector\" must be set\n\n")
		sb.WriteString("  any_server {}\n")
	...
	case "tcp_loadbalancer":
		...
		sb.WriteString("  // One of the arguments from this list \"advertise_custom advertise_on_public advertise_on_public_default_vip do_not_advertise\" must be set\n\n")
		sb.WriteString("  advertise_on_public_default_vip {}\n\n")
	...
	case "virtual_host":
		...
		sb.WriteString("  proxy                       = \"DNS_PROXY\"\n")
		sb.WriteString("  idle_timeout                = 30000\n")
		sb.WriteString("  connection_idle_timeout      = 120000\n")
		sb.WriteString("  max_request_header_size      = 32768\n")
		sb.WriteString("  add_location                = false\n")
		sb.WriteString("  disable_dns_resolve         = false\n")
		sb.WriteString("  disable_default_error_pages = false\n")
		sb.WriteString("  request_headers_to_remove   = []\n")
		sb.WriteString("  response_headers_to_remove  = []\n")
		sb.WriteString("  request_cookies_to_remove   = []\n")
		sb.WriteString("  response_cookies_to_remove  = []\n")
	...
	case "workload":
		...
		sb.WriteString("      }\n")
		sb.WriteString("    }\n")
		sb.WriteString("    deploy_options {\n")
		sb.WriteString("      default_virtual_sites {}\n")
		sb.WriteString("    }\n")
		sb.WriteString("  }\n")

	case "workload_flavor":
		sb.WriteString("\n  vcpus             = 1\n")
	...
	case "malicious_user_mitigation":
		...
		sb.WriteString("  mitigation_type {\n")
		sb.WriteString("    rules {\n")
		sb.WriteString("      threat_level {\n")
		sb.WriteString("        high {}\n")
		sb.WriteString("      }\n")
		sb.WriteString("      mitigation_action {\n")
		sb.WriteString("        block_temporarily {}\n")
		sb.WriteString("      }\n")
		sb.WriteString("    }\n")
		sb.WriteString("  }\n")
